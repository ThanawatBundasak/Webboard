...
<body>
    <div class="container">
        <h1 class="text-center">Webboard Thanawat</h1>
                    ...
                    <div class="card-body">
                        <form action="register_save.php" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <div class="form-check">
                                        <input type="radio" name="gender" value="m" class="form-check-input" required></input>
                                        <label class="form-check-label">ชาย</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" name="gender" value="f" class="form-check-input" required></input>
                                        <label class="form-check-label">หญิง</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" name="gender" value="o" class="form-check-input" required></input>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <button class="btn btn-primary btn-sm" type="summit"><i class="bi bi-save"></i> สมัครสมาชิก</button>
                                </div>
                            </div>
                        </form>
                    </div>
